...
## Scope, Goals and Risk Assessment Report Info
### Current assets
...
- Advanced understanding of risk assessment and threat analysis
- Proficiency in analyzing and identifying security gaps and vulnerabilities
- Evaluating security controls and policies
- Development of critical thinking and problem-solving skills in cybersecurity
- Documentation, reporting, and audit evidence collection
- Communicating technical findings to non-technical stakeholders
- Developing remediation and risk mitigation recommendations
- Cross-referencing information to ensure they are accurate
...
- Google Docs – Audit evidence and tracking all information including checklist, findings and reccommmendations for the company.



## Steps
1. Read and reviewed all information given to me.
2. Started cross referencing information and marking down information found in my checklist.
3. Researched the relevant updates that the company should make to strengthen business continuity, security and data protection.
4. Made reccommendations for the company.
